...
function Products() {
  const sampleItems = useMemo(() => [
    ...
    { title: 'libary M', live: true, case: false, discription: 'Developed a Library Management System using the MERN stack (MongoDB, Express, React, Node.js) to manage books, users, and transactions. Implemented secure authentication, CRUD operations, and an intuitive dashboard for efficient library administration.' },
    { title: 'Ad.todo', live: true, case: false, discription: 'Built an Advanced To-Do Application with React and Framer Motion, featuring smooth animations for adding, updating, and deleting tasks. Implemented interactive UI elements, state management, and responsive design for an engaging user experience.' },
    { title: 'deacthlon', live: true, case: false, discription: 'Developed a Deacthlon website using React, Framer Motion, and Locomotive Scroll for smooth transitions and parallax effects. Integrated Git for version control and delivered a visually engaging, high-performance interactive user experience.' },
  ], [])
