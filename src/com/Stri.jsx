...
function Stri() {
  var data =[
    {url:"https://assets-global.website-files.com/6334198f239547d0f9cd84b3/63c9ce90a51cd7cf6b3689fb_css-design-awards-logos-id1L9L8Yvp%201.svg", number:28},
    ...
    {url:"https://assets-global.website-files.com/6334198f239547d0f9cd84b3/63c9ce90a51cd7cf6b3689fb_css-design-awards-logos-id1L9L8Yvp%201.svg", number:1},
  ...
  return (
    <div className='flex  items-center '>
      {data.map((item,index)=>{
        return(
          <Str key={index} url={item.url} number={item.number}/>
        )
      })}
